...
AS
BEGIN
  SELECT IFH.unlssueFileId,IFH.stComment,F.stFileName,F.stUnFileName,DV.stDivisionName,UP.stFirstName +' '+UP.stLastName AS stUserName,DP.stDepartmentName,F.inStoreFileDetailsId,IFH.inAssignUserId,IFH.inlssueFileId

...
namespace FileSystemWeb.Areas.Divisions.Controllers
{
    ...
    public class AlmirahController : Controller
    {
        ...
        {
            return View("~/Areas/Divisions/Views/Almirah/AlmirahList.cshtml");
        }
        ...
        public IActionResult Detail(Guid id)
        {
            ...
            return View("~/Areas/Divisions/Views/Almirah/AlmirahDetail.cshtml", loAlmirah);
        }
...
*/
                ...
                return PartialView("~/Areas/Divisions/Views/Almirah/_AlmirahListData.cshtml", loModel);
            }
            catch (Exception ex)
            {

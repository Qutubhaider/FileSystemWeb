...
namespace DmfWeb.Areas.Divisions.Controllers
{
    ...
    public class DivisionController : Controller
    {
        ...
        {
            return View("~/Areas/Divisions/Views/Divistion/DivistionList.cshtml");
        }
        public IActionResult Detail(Guid id)
        {
            ...
            return View("~/Areas/Divisions/Views/Divistion/DivisionDetail.cshtml", loDivision);
        }
        ...
        public IActionResult GetDivisionList(string DivisionName, int? Status, int? sort_column, string sort_order, int? pg, int? size)
        {
            ...
            try
            {
                ...
                return PartialView("~/Areas/Divisions/Views/Divistion/_DivistionListData.cshtml", loModel);
            }
            catch (Exception ex)
            {

...
namespace FileSystemWeb.Areas.Divisions.Controllers
{
    ...
    public class StoreController : Controller
    {
        ...
        {
            return View("~/Areas/Divisions/Views/Store/StoreList.cshtml");
        }
        ...
        public IActionResult Detail(Guid id)
        {
            ...
            return View("~/Areas/Divisions/Views/Store/StoreDetail.cshtml", loStore);
        }
        ...
        public IActionResult GetStoreList(string StoreName, int? Status, int? sort_column, string sort_order, int? pg, int? size)
        {
            ...
            try
            {
                ...
                return PartialView("~/Areas/Divisions/Views/Store/_StoreListData.cshtml", loModel);
            }
            catch (Exception ex)
            {

...
namespace DmfWeb.Areas.Divisions.Controllers
{
    ...
    public class DepartmentController : Controller
    {
        ...
        {
            return View("~/Areas/Divisions/Views/Department/DepartmentList.cshtml");
        }
        public IActionResult Detail(Guid id)
        {
            ...
            return View("~/Areas/Divisions/Views/Department/DepartmentDetail.cshtml", loDepartment);
        }
        ...
        public IActionResult GetDepartmentList(string DepartmentName, int? sort_column, string sort_order, int? pg, int? size)
        {
            ...
            try
            {
                ...
                return PartialView("~/Areas/Divisions/Views/Department/_DepartmentListData.cshtml", loModel);
            }
            catch (Exception ex)
            {

...
namespace FileSystemWeb.Areas.Divisions.Controllers
{
    ...
    public class FileController : Controller
    {
        ...
        {
            return View("~/Areas/Divisions/Views/File/FileList.cshtml");
        }
        public IActionResult Detail(Guid id)
        {
            ...
            return View("~/Areas/Divisions/Views/File/FileDetail.cshtml", loFileDetail);
        }
...
*/
                ...
                return PartialView("~/Areas/Divisions/Views/File/_FileListData.cshtml", loModel);
            }
            catch (Exception ex)
            {

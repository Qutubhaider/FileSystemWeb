...
namespace FileSystemWeb.Areas.Departments.Controllers
{
    ...
    public class AlmirahController : Controller
    {
        ...
        {
            return View("~/Areas/Departments/Views/Almirah/AlmirahList.cshtml");
        }
        ...
        public IActionResult Detail(Guid id)
        {
            ...
            return View("~/Areas/Departments/Views/Almirah/AlmirahDetail.cshtml", loAlmirah);
        }
...
*/
                ...
                return PartialView("~/Areas/Departments/Views/Almirah/_AlmirahListData.cshtml", loModel);
            }
            catch (Exception ex)
            {

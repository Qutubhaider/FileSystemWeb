...
namespace FileSystemWeb.Areas.Departments.Controllers
{
    ...
    public class ShelvesController : Controller
    {
        ...
        {
            return View("~/Areas/Departments/Views/Shelves/ShelvesList.cshtml");
        }
        ...
        public IActionResult Detail(Guid id)
        {
            ...
            return View("~/Areas/Departments/Views/Shelves/ShelvesDetail.cshtml", loShelve);
        }
...
*/
                ...
                return PartialView("~/Areas/Departments/Views/Shelves/_ShelvesListData.cshtml", loModel);
            }
            catch (Exception ex)
            {

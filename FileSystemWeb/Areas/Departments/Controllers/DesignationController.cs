...
namespace FileSystemWeb.Areas.Departments.Controllers
{
    ...
    public class DesignationController : Controller
    {
        ...
        {
            return View("~/Areas/Departments/Views/Designation/DesignationList.cshtml");
        }
        public IActionResult Detail(Guid id)
        {
            ...
            return View("~/Areas/Departments/Views/Designation/DesignationDetail.cshtml", loDesignation);
        }
        ...
        public IActionResult GetDesignationList(string DesignationName, int? sort_column, string sort_order, int? pg, int? size)
        {
            ...
            try
            {
                ...
                return PartialView("~/Areas/Departments/Views/Designation/_DesignationListData.cshtml", loModel);
            }
            catch (Exception ex)
            {

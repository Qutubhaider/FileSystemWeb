...
namespace FileSystemWeb.Areas.Departments.Controllers
{
    ...
    public class RoomController : Controller
    {
        ...
        {
            return View("~/Areas/Departments/Views/Room/RoomList.cshtml");
        }
        ...
        public IActionResult Detail(Guid id)
        {
            ...
            return View("~/Areas/Departments/Views/Room/RoomDetail.cshtml", loRoom);
        }
...
*/
                ...
                return PartialView("~/Areas/Departments/Views/Room/_RoomListData.cshtml", loModel);
            }
            catch (Exception ex)
            {

...
namespace DmfWeb.Areas.Departments.Controllers
{
    ...
    public class DivisionController : Controller
    {
        ...
        {
            return View("~/Areas/Departments/Views/Divistion/DivistionList.cshtml");
        }
        public IActionResult Detail(Guid id)
        {
            ...
            return View("~/Areas/Departments/Views/Divistion/DivisionDetail.cshtml", loDivision);
        }
        ...
        public IActionResult GetDivisionList(string DivisionName, int? Status, int? sort_column, string sort_order, int? pg, int? size)
        {
            ...
            try
            {
                ...
                return PartialView("~/Areas/Departments/Views/Divistion/_DivistionListData.cshtml", loModel);
            }
            catch (Exception ex)
            {

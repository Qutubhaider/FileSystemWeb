...
namespace FileSystemWeb.Areas.Departments.Controllers
{
    ...
    public class DeskController : Controller
    {
        ...
        {
            return View("~/Areas/Departments/Views/Desk/DeskList.cshtml");
        }
        public IActionResult Detail(Guid id)
        {
            ...
            return View("~/Areas/Departments/Views/Desk/DeskDetail.cshtml", loDesk);
        }
        ...
        public IActionResult GetDeskList(string DeskName, int? Status, int? sort_column, string sort_order, int? pg, int? size)
        {
            ...
            try
            {
                ...
                return PartialView("~/Areas/Departments/Views/Desk/_DeskListData.cshtml", loModel);
            }
            catch (Exception ex)
            {

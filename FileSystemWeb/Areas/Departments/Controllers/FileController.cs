...
namespace FileSystemWeb.Areas.Departments.Controllers
{
    ...
    public class FileController : Controller
    {
        ...
        {
            return View("~/Areas/Departments/Views/File/FileList.cshtml");
        }
        public IActionResult Detail(Guid id)
        {
            ...
            return View("~/Areas/Departments/Views/File/FileDetail.cshtml", loFileDetail);
        }
...
*/
                ...
                return PartialView("~/Areas/Departments/Views/File/_FileListData.cshtml", loModel);
            }
            catch (Exception ex)
            {
